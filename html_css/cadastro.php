             ...
             <?php
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    ...
                    if (empty(array_filter($erros))) {
                        /* 1. Inserir usuário
                        $sql_usuario = "INSERT INTO usuario (id_perfil, nomecompleto, datanascimento, sexo, nomematerno, cpf, email, telefonecelular, telefonefixo, login, senha) 
                        VALUES (1, '{$dados['nome_completo']}', '{$dados['data_nascimento']}', '{$dados['sexo']}', '{$dados['nome_materno']}', '{$dados['cpf']}', '{$dados['email']}', '{$dados['telefone_celular']}', '{$dados['telefone_fixo']}', '{$dados['login']}', '{$dados['senha']}')";
